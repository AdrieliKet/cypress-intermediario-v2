...
Este repositório foi criado para o curso de Cypress Intermediário da Udemy.

Durante o curso de testes automatizados com Cypress (intermediário) foi abordado:
...
Curso: (https://udemy.com/user/walmyr).
